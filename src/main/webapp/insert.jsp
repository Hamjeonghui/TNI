        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">작품 등록</h4>
              <p class="mb-4">모든 입력은 필수사항입니다.</p>

              <form id="formAuthentication" class="mb-3" action="insert.do?uid=${uid}&uname=${uname}" method="POST" enctype="multipart/form-data"><!-- 이미지 인코딩설정 -->
                <%-- 글제목 --%>
                <div class="mb-3">
				...
				<div class="mb-3">
                  ...
                  <textarea class="form-control" id="exampleFormControlTextarea1" name="acontent" required="required"
									rows="3" style="resize: none; height: 100px;" placeholder="상세 내용"></textarea>
                </div>
                <%-- /글 내용 --%>
                <%-- 이미지 --%>
                <div class="mb-3">
                  <label for="formFile" class="form-label">이미지 첨부</label>
                  <input class="form-control" type="file" id="formFile" required="required" name="uploadFile"/>
                </div>
                <%-- /이미지 --%>
               <%-- 작업부위 --%>
               <div class="mb-3">
