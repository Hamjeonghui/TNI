...
<body>
	...
	<div class="container-xxl" style="width: 80%;">
				...
				<div class="card">
					<div class="card-body">
                      ...
                      <g id="g-app-brand" stroke="none" stroke-width="1"
						...
						<p class="mb-4">입력하실 모든 정보들은 필수사항 입니다.</p>

						<form id="formAuthentication" class="mb-3" action="signup.do"
							method="POST">
							<%-- 회원 권한 --%>
							<div class="col-md mb-3">
								<small class="fw-semibold d-block">회원 구분</small>
								<div class="form-check form-check-inline mt-3">
									<input class="form-check-input" type="radio" name="uauth"
										id="inlineRadio1" value="0" checked="checked" /> <label
										class="form-check-label" for="inlineRadio1">일반</label>
								</div>
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="uauth"
										id="inlineRadio2" value="1" /> <label
										class="form-check-label" for="inlineRadio2">타투이스트</label>
								</div>
							</div>
							<%-- /회원 권한 --%>
							<%-- 사용자 이름 --%>
							<div class="mb-3">
								<label for="username" class="form-label">이름</label> <input
									...
									placeholder="이름을 입력하세요." autofocus required="required" />
							</div>
							<%-- /사용자 이름 --%>
							<%-- 아이디 --%>
							<div class="mb-3">
								<label for="username" class="form-label">아이디<br> <font id="checkID" size="2"></font></label> <input
									type="text" class="form-control" id="input_uid" name="uid"
									placeholder="사용하실 아이디를 입력하세요." required="required" />
							</div>
							<%-- /아이디 --%>
							<%-- 비밀번호 --%>
							...
							<div class="mb-3 row">
								...
								<div class="col-md-10">
									<input class="form-control" type="date" required="required" name="ubirth"
										id="html5-date-input" />
								</div>
							</div>
							<%-- /생년월일 --%>
							...
							<div>
								...
								<textarea class="form-control" id="exampleFormControlTextarea1"
									rows="3" style="resize: none; height: 300px;"
									readonly="readonly">
									제 1장 총칙
...
부 칙 1. (시행일) 본 약관은 2016년 1월 1일부터 시행됩니다.
								...
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="ckeck01"
										required="required" id="inlineRadio2" value="1" /> <label
										class="form-check-label" for="inlineRadio2">약관에 동의합니다.</label>
								</div>
							</div>
							<%-- /이용 약관 --%>
							<%-- 개인정보 수집 및 이용약관 --%>
							<div>
								<label for="exampleFormControlTextarea1" class="form-label">개인정보
									수집 및 이용약관</label>
								<textarea class="form-control" id="exampleFormControlTextarea1"
									rows="3" style="resize: none; height: 300px;"
									readonly="readonly">
...
부 칙 1. (시행일) 본 약관은 2016년 1월 1일부터 시행됩니다.
								...
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="ckeck02"
										required="required" id="inlineRadio2" value="1" /> <label
										class="form-check-label" for="inlineRadio2">약관에 동의합니다.</label>
								</div>
							</div>
						...
						<p class="text-center">
							<span>가입하신 아이디가 있으신가요?</span> <a href="login.jsp"> <span>로그인하러
									가기</span>
							</a>
						</p>
					</div>
	...
	<script src="js_1/birth.js"></script>
